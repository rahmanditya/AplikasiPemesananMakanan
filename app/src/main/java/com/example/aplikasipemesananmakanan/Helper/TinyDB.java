...
public class TinyDB {
    ...
    public ArrayList<ManagementCart> getListObject2(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ManagementCart> playerList =  new ArrayList<ManagementCart>();

        for(String jObjString : objStrings){
            ManagementCart player  = gson.fromJson(jObjString,  ManagementCart.class);
            playerList.add(player);
        }
        return playerList;
    }
